...
{
    public class DAD_Contract_Under3M : ReportClass
    {
        public override string ResourceName
        {
            get { return "DAD_Contract_Under3M.rpt"; }
            set { }
        }
        ...
        {
            get { return "HumanResources.Reports.DAD.Contract.DAD_Contract_Under3M.rpt"; }
            set { }
        }
    ...
    public class CachedDAD_Contract_Under3M : Component, ICachedReport
    {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        {
            var rpt = new DAD_Contract_Under3M();
            rpt.Site = Site;
            return rpt;
        }
