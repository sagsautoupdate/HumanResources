...
{
    public class DAD_Contract : ReportClass
    {
        public override string ResourceName
        {
            get { return "DAD_Contract.rpt"; }
            set { }
        }
        ...
        {
            get { return "HumanResources.Reports.DAD.Contract.DAD_Contract.rpt"; }
            set { }
        }
    ...
    public class CachedDAD_Contract : Component, ICachedReport
    {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
