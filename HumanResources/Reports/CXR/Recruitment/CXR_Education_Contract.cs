...
namespace HumanResources.Reports.CXR.Recruitment
{
    public class CXR_Education_Contract : ReportClass
    {
        public override string ResourceName
        {
            get { return "CXR_Education_Contract.rpt"; }
            set { }
        }
        ...
        {
            get { return "HumanResources.Reports.CXR.Recruitment.CXR_Education_Contract.rpt"; }
            set { }
        }
    ...
    public class CachedCXR_Education_Contract : Component, ICachedReport
    {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        {
            var rpt = new CXR_Education_Contract();
            rpt.Site = Site;
            return rpt;
        }
