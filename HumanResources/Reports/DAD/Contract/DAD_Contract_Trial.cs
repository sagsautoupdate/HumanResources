...
{
    public class DAD_Contract_Trial : ReportClass
    {
        public override string ResourceName
        {
            get { return "DAD_Contract_Trial.rpt"; }
            set { }
        }
        ...
        {
            get { return "HumanResources.Reports.DAD.Contract.DAD_Contract_Trial.rpt"; }
            set { }
        }
    ...
    public class CachedDAD_Contract_Trial : Component, ICachedReport
    {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        {
            var rpt = new DAD_Contract_Trial();
            rpt.Site = Site;
            return rpt;
        }
