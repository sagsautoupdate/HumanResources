...
{
    public class CXR_Contract_Trial : ReportClass
    {
        public override string ResourceName
        {
            get { return "CXR_Contract_Trial.rpt"; }
            set { }
        }
        ...
        {
            get { return "HumanResources.Reports.CXR.Contract.CXR_Contract_Trial.rpt"; }
            set { }
        }
    ...
    public class CachedCXR_Contract_Trial : Component, ICachedReport
    {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        {
            var rpt = new CXR_Contract_Trial();
            rpt.Site = Site;
            return rpt;
        }
