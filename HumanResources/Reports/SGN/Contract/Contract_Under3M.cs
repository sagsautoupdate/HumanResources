...
{
    public class Contract_Under3M : ReportClass
    {
        public override string ResourceName
        {
            get { return "Contract_Under3M.rpt"; }
            set { }
        }
        ...
        {
            get { return "HumanResources.Reports.SGN.Contract.Contract_Under3M.rpt"; }
            set { }
        }
    ...
    public class CachedContract_Under3M : Component, ICachedReport
    {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
