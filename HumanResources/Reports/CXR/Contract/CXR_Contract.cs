...
{
    public class CXR_Contract : ReportClass
    {
        public override string ResourceName
        {
            get { return "CXR_Contract.rpt"; }
            set { }
        }
        ...
        {
            get { return "HumanResources.Reports.CXR.Contract.CXR_Contract.rpt"; }
            set { }
        }
    ...
    public class CachedCXR_Contract : Component, ICachedReport
    {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
