...
{
    public class Contract_Trial : ReportClass
    {
        public override string ResourceName
        {
            get { return "Contract_Trial.rpt"; }
            set { }
        }
        ...
        {
            get { return "HumanResources.Reports.SGN.Contract.Contract_Trial.rpt"; }
            set { }
        }
    ...
    public class CachedContract_Trial : Component, ICachedReport
    {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
