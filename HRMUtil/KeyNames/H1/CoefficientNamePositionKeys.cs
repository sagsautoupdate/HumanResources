...
{
    public sealed class CoefficientNamePositionKeys
    {
        /// <summary>
        ...
        public const string SP_COEFFICIENT_NAME_POSITION_GET_BY_POSITION_ID =
            "Sel_H1_CoefficientNamePositions_By_PositionId";
    }
}