...
{
    public class CXR_Contract_Under3M : ReportClass
    {
        public override string ResourceName
        {
            get { return "CXR_Contract_Under3M.rpt"; }
            set { }
        }
        ...
        {
            get { return "HumanResources.Reports.CXR.Contract.CXR_Contract_Under3M.rpt"; }
            set { }
        }
    ...
    public class CachedCXR_Contract_Under3M : Component, ICachedReport
    {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        {
            var rpt = new CXR_Contract_Under3M();
            rpt.Site = Site;
            return rpt;
        }
