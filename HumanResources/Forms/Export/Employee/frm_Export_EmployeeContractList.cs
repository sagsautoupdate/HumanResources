...
{
    public partial class frm_Export_EmployeeContractList : RadForm
    {
        private static frm_Export_EmployeeContractList s_Instance;
        private readonly RadWaitingBar rwb = new RadWaitingBar();

        public frm_Export_EmployeeContractList()
        {
            InitializeComponent();
        }

        public static frm_Export_EmployeeContractList Instance
        {
            get
            {
                if (s_Instance == null)
                    s_Instance = new frm_Export_EmployeeContractList();
                return s_Instance;
            }
        }

        private void frm_Export_EmployeeContractList_Load(object sender, EventArgs e)
        {
        ...
        {
            radGridView1.DataSource = EmployeeContractBLL.GetAll();
        }
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            MessageBox.Show("Thành công. File đc lưu ngoài Desktop", "Info", MessageBoxButtons.OK,
        ...
        private void Filter()
        {
            ...
            var filterActive = new FilterDescriptor();
            filterActive.PropertyName = "Active";
            filterActive.Operator = FilterOperator.IsEqualTo;
            filterActive.Value = "True";
            filterActive.IsFilterEditor = true;
            ...
            if (rbActive.Checked)
                radGridView1.FilterDescriptors.Add(filterActive);
            else
                radGridView1.FilterDescriptors.Remove(filterActive);
        }

        private void rbActive_ToggleStateChanged(object sender, StateChangedEventArgs args)
        {
            Filter();
        }
    }
