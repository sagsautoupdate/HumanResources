...
namespace HumanResources.Reports.DAD.Contract
{
    public class DAD_Subcontract_Contract : ReportClass
    {
        public override string ResourceName
        {
            get { return "DAD_Subcontract_Contract.rpt"; }
            set { }
        }
        ...
        {
            get { return "HumanResources.Reports.DAD.Contract.DAD_Subcontract_Contract.rpt"; }
            set { }
        }
    ...
    public class CachedDAD_Subcontract_Contract : Component, ICachedReport
    {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        {
            var rpt = new DAD_Subcontract_Contract();
            rpt.Site = Site;
            return rpt;
        }
