...
namespace HumanResources.Reports.SGN.Recruitment
{
    public class Education_Contract : ReportClass
    {
        public override string ResourceName
        {
            get { return "Education_Contract.rpt"; }
            set { }
        }
        ...
        {
            get { return "HumanResources.Reports.SGN.Recruitment.Education_Contract.rpt"; }
            set { }
        }
    ...
    public class CachedEducation_Contract : Component, ICachedReport
    {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        {
            var rpt = new Education_Contract();
            rpt.Site = Site;
            return rpt;
        }
