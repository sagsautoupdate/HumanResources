...
{
    public partial class frm_Employee_Detail_B1024 : RadForm
    {
        ...
        public frm_Employee_Detail_B1024()
        {
            InitializeComponent();
        ...
        public frm_Employee_Detail_B1024(frm_Employee_Working few, int UserId, string FullName)
        {
            InitializeComponent();
            Utilities.Utilities.SetFormSize(this);
            Utilities.Utilities.SetScreenColor(this);
        ...
        {
            tableLayoutPanel5.BackColor = Color.AliceBlue;
        ...
        private void InitData(int userId)
        {
            ...
            label1.Text = dr["FullName"].ToString().ToUpper() +
                          $" ({StringFormat.GetUserCodeX6(Convert.ToInt32(dr["UserId"]))})";
            label2.Text = dr["PositionName"].ToString();
        ...
        private void SaveEducation()
        {
            ...
            foreach (var row in rgvHocVan.Rows)
            {
                ...
                if (id > 0)
                {
                    var dr1 = EmployeeEducationLevelsBLL.GetByFilter(_UserId, educationid, educationvalue);
                    _old =
            ...
            foreach (var item in rgvHocVan.Rows)
                try
                {
                    ...
                    if (isChecked)
                    {
                        var dr2 = EmployeeEducationLevelsBLL.GetByFilter(_UserId,
                            ChangeID(item.Cells["Name"].Value.ToString()), string.Empty);
        ...
        private void btnSavetvtg_Click(object sender, EventArgs e)
        {
            Cursor.Current = Cursors.AppStarting;
            {
                ...
                if (radPageView1.SelectedPage == pvpGeneral)
                {
                    ...
                    {
                        _SocialInsuranceNo = string.Empty;
                    }
                    EmployeesBLL.UpdateRadCongViec(cbStatus.Checked ? 1 : 0,
                        _TaxCode, _AccountNo, _CardNo, _BankName, string.Empty, _SocialInsuranceNo, _UserId);
                ...
                {
                    if (radPageView1.SelectedPage == pvpEducation)
                    {
                        SaveEducation();
                    ...
                    {
                        if (radPageView1.SelectedPage == pvpRelationship)
                        {
                            foreach (var row in rgvQuanHe.Rows)
                            {
                                ...
                                var _Live = row.Cells["RLive"].Value == null
                                    ? string.Empty
                                    : row.Cells["RLive"].Value.ToString();
                                ...
                                var _Others = row.Cells["Others"].Value == null
                                    ? string.Empty
                                    : row.Cells["Others"].Value.ToString();
                        ...
                        {
                            if (radPageView1.SelectedPage == pvpWorked)
                            {
                                foreach (var row in rgvCongTac.Rows)
                                {
                                    ...
                                    {
                                        dr =
                                            EmployeeJobHistoryBLL.GetOne(Convert.ToInt32(row.Cells["JobHistoryId"].Value));
                                    }
                                    catch
                                    {
                                    }
                                    ...
                                    try
                                    {
                                        var objBLL = new EmployeeJobHistoryBLL
                                        {
                                            FromYear =
                                                ...
                                                (row.Cells["FromYear"].Value.ToString() == string.Empty)
                                                    ? 0
                                                    : Convert.ToInt32(row.Cells["FromYear"].Value),
                                            ToYear =
                                                (row.Cells["ToYear"].Value == null) ||
                                                (row.Cells["ToYear"].Value.ToString() == string.Empty)
                                                    ? 0
                                                    : Convert.ToInt32(row.Cells["ToYear"].Value),
                                            Infor =
                                                (row.Cells["Infor"].Value == null) ||
                                                (row.Cells["Infor"].Value.ToString() == string.Empty)
                                                    ? string.Empty
                                            ...
                                            JobHistoryId =
                                                ...
                                                (row.Cells["JobHistoryId"].Value.ToString() == string.Empty)
                                                    ? 0
                                    ...
                                    {
                                        Utilities.Utilities.SaveHRMLog("H0_EmployeeJobHistory", _SP, _SPValue,
                                            _OldContent);
                                    }
                                }
                            ...
                            {
                                if (radPageView1.SelectedPage == pvpReward)
                                {
                                ...
                                {
                                    if (radPageView1.SelectedPage == pvpDisciplined)
                                    {
