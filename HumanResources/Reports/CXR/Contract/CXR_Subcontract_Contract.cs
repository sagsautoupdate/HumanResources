...
namespace HumanResources.Reports.CXR.Contract
{
    public class CXR_Subcontract_Contract : ReportClass
    {
        public override string ResourceName
        {
            get { return "CXR_Subcontract_Contract.rpt"; }
            set { }
        }
        ...
        {
            get { return "HumanResources.Reports.CXR.Contract.CXR_Subcontract_Contract.rpt"; }
            set { }
        }
    ...
    public class CachedCXR_Subcontract_Contract : Component, ICachedReport
    {
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        {
            var rpt = new CXR_Subcontract_Contract();
            rpt.Site = Site;
            return rpt;
        }
